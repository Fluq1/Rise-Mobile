...
const HomeScreen = ({ navigation }) => {
  ...
  const [featuredProducts, setFeaturedProducts] = useState([
    { 
      ...
      price: 'R$ 129,90',
      discount: '20%',
      image: require('../../assets/logo.webp') // Usando uma imagem existente como fallback
    },
    { 
      id: '2', 
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Image 
          source={require('/Users/heitor/Aulas LOCAL/BOER/outro/Rise-Mobile/assets/logo.webp')} 
          style={styles.logo}
          resizeMode="contain"
        />
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.banner}>
          <Image 
            source={require('../../assets/logo.webp')} // Usando uma imagem existente como fallback
